...
import com.aadira.library.Models.ProductImage;
...
public class ProductParser extends com.aadira.library.Models.Product {
    ...
    public ArrayList<com.aadira.library.Models.Product> productsParser() throws JSONException {
        ArrayList<com.aadira.library.Models.Product> productsList = new ArrayList<>();
...
//            A.logDebugMessage(object1.toString());
            com.aadira.library.Models.Product product = new com.aadira.library.Models.Product();
...
//            product.created_at = new Date(object1.getString(""));
            ...
            ArrayList<com.aadira.library.Models.ProductImage> productImageArrayList = new ArrayList<>();
            for (int j = 0; j < array1.length(); j++) {
                com.aadira.library.Models.ProductImage image = new com.aadira.library.Models.ProductImage();
    ...
    public com.aadira.library.Models.Product singleProductParser() throws JSONException {
        com.aadira.library.Models.Product product = new Product();
...
//            product.created_at = new Date(object1.getString(""));
            ...
            ArrayList<com.aadira.library.Models.ProductImage> productImageArrayList = new ArrayList<>();
            for (int j = 0; j < array1.length(); j++) {
                com.aadira.library.Models.ProductImage image = new ProductImage();
                JSONObject object3 = array1.getJSONObject(j);
                image.id = object3.getLong("id");
                image.src = object3.getString("src");
                image.title = object3.getString("title");
